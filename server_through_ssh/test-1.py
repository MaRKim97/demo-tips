...
command = '/home/team002/workspace/server_test/run-1.sh' + ' ' + prompt  # Make sure the script is executable
remote_file_path = '/home/team002/workspace/server_test/result1.png'  # The path where 'result.png' is saved on the remote machine
local_file_path = './result1.png'  # Where to save 'result.png' locally
